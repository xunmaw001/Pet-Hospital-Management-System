    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="宠物信息" prop="chongwuxinxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="宠物信息"
                  v-model="ruleForm.chongwuxinxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chongwuxinxi" label="宠物信息" prop="chongwuxinxi">
                    <span>{{ruleForm.chongwuxinxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouling = true;
          ...
          if(o=='chongwuxinxi'){
            this.ruleForm.chongwuxinxi = obj[o];
	    this.ro.chongwuxinxi = true;
            continue;
          }
